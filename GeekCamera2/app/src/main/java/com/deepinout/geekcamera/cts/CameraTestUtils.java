...
import com.deepinout.geekcamera.cts.helpers.CameraErrorCollector;
import com.deepinout.geekcamera.cts.helpers.StaticMetadata;
import android.hardware.camera2.params.InputConfiguration;
import android.hardware.camera2.TotalCaptureResult;
import com.deepinout.geekcamera.cts.CameraUtils;
...
import com.deepinout.geekcamera.ex.camera2.blocking.BlockingCameraManager;
import com.deepinout.geekcamera.ex.camera2.blocking.BlockingCameraManager.BlockingOpenException;
import com.deepinout.geekcamera.ex.camera2.blocking.BlockingSessionCallback;
import com.deepinout.geekcamera.ex.camera2.blocking.BlockingStateCallback;
import com.deepinout.geekcamera.ex.camera2.exceptions.TimeoutRuntimeException;
...
public class CameraTestUtils extends Assert {
    ...
    public static class SimpleCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        /**
         * Get the #CaptureResult capture result for a given
         * #CaptureRequest capture request.
         *
         * @param myRequest The #CaptureRequest capture request whose
         *            corresponding #CaptureResult capture result was
         *            being waited for
        ...
        /**
         * Get the #TotalCaptureResult total capture result for a given
         * #CaptureRequest capture request.
         *
         * @param myRequest The #CaptureRequest capture request whose
         *            corresponding #TotalCaptureResult capture result was
         *            being waited for
         * @param numResultsWait Number of frames to wait for the capture result
         *            before timeout.
         * @throws TimeoutRuntimeException If more than numResultsWait results are
        ...
        /**
         * Get an array of #TotalCaptureResult total capture results for a given list of
         * #CaptureRequest capture requests. This can be used when the order of results
         * may not the same as the order of requests.
         *
         * @param captureRequests The list of #CaptureRequest capture requests whose
         *            corresponding #TotalCaptureResult capture results are
         *            being waited for.
        ...
        /**
         * Get an array list of #CaptureFailure capture failure with maxNumFailures entries
     ...
     * trying to spy on  BlockingStateCallback (or others) will cause unnecessary extra
